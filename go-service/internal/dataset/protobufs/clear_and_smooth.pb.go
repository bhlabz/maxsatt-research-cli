...
func (x *ClearAndSmoothRequest) Reset() {
	*x = ClearAndSmoothRequest{}
	mi := &file_internal_delta_clear_and_smooth_proto_msgTypes[0]
...
func (*ClearAndSmoothRequest) Descriptor() ([]byte, []int) {
	return file_internal_delta_clear_and_smooth_proto_rawDescGZIP(), []int{0}
}
...
func (x *ClearAndSmoothResponse) Reset() {
	*x = ClearAndSmoothResponse{}
	mi := &file_internal_delta_clear_and_smooth_proto_msgTypes[1]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*ClearAndSmoothResponse) Descriptor() ([]byte, []int) {
	return file_internal_delta_clear_and_smooth_proto_rawDescGZIP(), []int{1}
}
...
func (x *DoubleList) Reset() {
	*x = DoubleList{}
	mi := &file_internal_delta_clear_and_smooth_proto_msgTypes[2]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*DoubleList) Descriptor() ([]byte, []int) {
	return file_internal_delta_clear_and_smooth_proto_rawDescGZIP(), []int{2}
}
...
var File_internal_delta_clear_and_smooth_proto protoreflect.FileDescriptor

const file_internal_delta_clear_and_smooth_proto_rawDesc = "" +
	"\n" +
	"%internal/delta/clear_and_smooth.proto\"\x93\x01\n" +
	...
	"\x0eClearAndSmooth\x12\x16.ClearAndSmoothRequest\x1a\x17.ClearAndSmoothResponseBWZUgithub.com/forest-guardian/forest-guardian-api-poc/internal/delta/protobufs;protobufsb\x06proto3"

var (
	file_internal_delta_clear_and_smooth_proto_rawDescOnce sync.Once
	file_internal_delta_clear_and_smooth_proto_rawDescData []byte
)

func file_internal_delta_clear_and_smooth_proto_rawDescGZIP() []byte {
	file_internal_delta_clear_and_smooth_proto_rawDescOnce.Do(func() {
		file_internal_delta_clear_and_smooth_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_internal_delta_clear_and_smooth_proto_rawDesc), len(file_internal_delta_clear_and_smooth_proto_rawDesc)))
	})
	return file_internal_delta_clear_and_smooth_proto_rawDescData
}

var file_internal_delta_clear_and_smooth_proto_msgTypes = make([]protoimpl.MessageInfo, 5)
var file_internal_delta_clear_and_smooth_proto_goTypes = []any{
...
var file_internal_delta_clear_and_smooth_proto_depIdxs = []int32{
...
func init() { file_internal_delta_clear_and_smooth_proto_init() }
func file_internal_delta_clear_and_smooth_proto_init() {
	if File_internal_delta_clear_and_smooth_proto != nil {
		return
	}
	type x struct{}
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_internal_delta_clear_and_smooth_proto_rawDesc), len(file_internal_delta_clear_and_smooth_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   5,
			NumExtensions: 0,
			NumServices:   1,
		},
		GoTypes:           file_internal_delta_clear_and_smooth_proto_goTypes,
		DependencyIndexes: file_internal_delta_clear_and_smooth_proto_depIdxs,
		MessageInfos:      file_internal_delta_clear_and_smooth_proto_msgTypes,
	}.Build()
	File_internal_delta_clear_and_smooth_proto = out.File
	file_internal_delta_clear_and_smooth_proto_goTypes = nil
	file_internal_delta_clear_and_smooth_proto_depIdxs = nil
}
